...
# Paths
RDIR="/Users/alberteenglund/Documents/DTU/8_Semester/22125_algorithms_in_bioinformatics/algorithms/BioAlgoProject2025/code"
RESDIR="/Users/alberteenglund/Documents/DTU/8_Semester/22125_algorithms_in_bioinformatics/algorithms/BioAlgoProject2025/results/PSSM"
  ...
  for beta in 5.0 10 50; do
    ...
    if [ -f concat.eval ]; then
      if [ ! -f "$eval_file" ]; then
        ...
        if [[ "$result" == *","*","* ]]; then
          echo "PSSM,$a,$result,$beta" >> ../../"$eval_file"
        else
